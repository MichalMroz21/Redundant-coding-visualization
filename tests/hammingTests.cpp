...
TEST(Hamming, hammingInitParity){
    ...
    QList<QString> data{"1101", "10110100110", "11010010010", "11011111011111101001010111",
                        "000010110010110001110101011001001110111001001110000100111",
                        "001100001000101010001001010000101111110001111100010000100101100010101011001000100110010011100000111110011010000101011010",
                        "0100101110111011100110101011001111110011001110101110011110111101110100111111101010000001010111000010011010010000101001010000100011111110110001101011101100001111000000101110111111000010011010111011010100110000101111001111001010111110111011000100011"};

    QList<std::pair<int, int>> results(expectedResults.size());

    auto makeResults = [](const QString& data) -> std::pair<int, int>{
         ...
         return {hammingCode.data()->getP(), hammingCode.data()->getM()};
    };
...
TEST(Hamming, hammingEncoding){
    ...
    QList<QString> data{"1110", "11010101100111011111010110", "11100001000", "00101010110", "01111000100000001001010001", "11100001011010010001110100",
                        "011000010010001110110100100001101001001110111001000111101", "111011011100001010101101000000101101100001000100101101100",
                        "100001111100101100000010010011000110011100010101111110001101110111110101001001000000100001101011110110101000000100010010",
                   ...
                   expectedResults{"0010110", "1111101001011001111011111010110", "001111010001000", "110101001010110", "1100111110001000000001001010001", "1111110100010110010010001110100",
                                   "010011010001001000011101101001000001101001001110111001000111101", "001011001101110100010101011010000000101101100001000100101101100",
    ...
    auto makeResults = [](const QString& data) -> QString{
        QString result{};
        QBitArray bits(data.size());
